                ...
                <div class="col-xl-6">
                    <div class="card-box widget-chart-one gradient-danger bx-shadow-lg">
                        ...
                        <div class="widget-chart-one-content text-right">
                            <p class="text-white mb-0 mt-2">Donars</p>
                    ...
                    <div class="card-box">
                        ...
                        <div class="mb-3 mt-4">
                            ...
                            {{--<img src="backend/assets/images/cards/visa.png" alt="user-card" height="28" />--}}
                            {{--<img src="backend/assets/images/cards/master.png" alt="user-card" height="28" />--}}
                            {{--<img src="backend/assets/images/cards/american-express.png" alt="user-card" height="28" />--}}
                            {{--</div>--}}
                    ...
                    <div class="card-box">
                        ...
                        <div class="row text-center">
                            <div class="col-sm-4 mb-3">
                                ...
                                <p class="text-muted text-overflow">Total Donors</p>
                            </div>
                            <div class="col-sm-4 mb-3">
                                <h3 class="font-weight-light">5,000</h3>
                                <i class="dripicons-user"></i>
                                <p class="text-muted text-overflow">Total Requests</p>
                            </div>
                            <div class="col-sm-4 mb-3">
